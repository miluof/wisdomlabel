...
// 			
			...
			//摄像头的颜色反了哦，所以改改
			/**y++=( RGB2YUV_YR[*b] +RGB2YUV_YG[*g]+RGB2YUV_YB[*r]+1048576)>>16;
			
			*u++=(-RGB2YUV_UR[*b] -RGB2YUV_UG[*g]+RGB2YUV_UBVR[*r]+8388608)>>16;
			
			*v++=( RGB2YUV_UBVR[*b]-RGB2YUV_VG[*g]-RGB2YUV_VB[*r]+8388608)>>16;*/
